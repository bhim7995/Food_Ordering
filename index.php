        ...
        <div class="collapse navbar-toggleable-md  float-lg-right" id="mainNavbarCollapse">
            <ul class="nav navbar-nav">
                ...
                if (empty($_SESSION["user_id"])) // if user is not login
                {
                    ...
                    echo '<li class="nav-item"><a href="#" class="nav-link active">About Us</a> </li>';
                }
                ?>
            </ul>
            </div>
...
<!-- banner part starts -->
 <section class="hero bg-image" data-image-src="images/img/main2_2.jpg">
    <div class="hero-inner">
        <div class="container text-center hero-text font-white">
            <h1>Delivering happiness to your Home</h1>
            <h5 class="font-white space-xs ">HEALTHY FOOD FOR HEALTHY BODY </h5>
            <div class="banner-form">
                <form class="form-inline">
                    <button onclick="location.href='restaurants.php'" type="button" class="btn theme-btn btn-lg">Order Now </button>
                    <button onclick="location.href='login.php'" type="button" class="btn theme-btn btn-lg">Book a Table </button>
                </form>
            </div>
            <!-- Steps start  -->
            <div class="steps">
...
<!-- DELETED SECTION -> How to download App on Android and Iphone -->
...
<!-- start: FOOTER -->
 ...
 <!-- top footer statrs -->
            <div class="row top-footer">
                ...
                <div class="col-sm-3 popular-locations color-gray">
                    <h5>Popular locations</h5>
                    <ul>
                        <li class="text-white">Murthal Paratha</li>
                        <li class="text-white">CU's FR </li>
                        <li class="text-white">Ludhiana foods </li>
                    </ul>
                </div>
            </div>
 <!-- top footer ends -->
  ...
  <!-- bottom footer statrs -->
            <div class="bottom-footer">
                <div class="row">
                    <div class="col-sm-3 address color-gray">
                        <h5>Address</h5>
                        <p>Near Chandigarh University , Mohali (Punjab) </p>
                    </div>
                    <div class="col-sm-3 color-gray">
                    <h5>Phone: <a href="tel:+91 9199670991">9199670991</a></h5>
                    <h5>Rahul Anand(CEO)</h5>
                    <h5>Shiv kumar(MD)</h5>
